...
$PAGE->requires->css(new moodle_url($CFG->wwwroot . '/local/recitdashboard/react_app_build/index.css?v='.rand(0,100)), true);
$PAGE->requires->js(new moodle_url($CFG->wwwroot . '/local/recitdashboard/react_app_build/index.js?v='.rand(0,100)), true);
