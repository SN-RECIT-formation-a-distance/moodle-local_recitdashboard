 ...
 */
require_once "$CFG->dirroot/local/recitcommon/php/RecitApi.php";
...
class DashboardApi extends MoodleApi
{
	public function __construct($DB, $COURSE, $USER){
        ...
        DashboardPersistCtrl::getInstance($DB, $USER);
    }
	...
	/*public function getCourseProgressionOverview($request){
        try{
			...
			$result = new stdClass();
			$result->details = DashboardPersistCtrl::getInstance()->getCourseProgressionOverview($courseId, $groupId);				
	...
	/*public function getCourseProgressionDetails($request){
        try{
			...
			$result = new stdClass();
			$result->details = DashboardPersistCtrl::getInstance()->getCourseProgressionDetails($courseId, $userId);			
			$this->prepareJson($result);
	...
	/*public function getCourseAttendance($request){
        try{
			...
			$result = new stdClass();
			$result->details = DashboardPersistCtrl::getInstance()->getCourseAttendance($courseId, $groupId);				
			$this->prepareJson($result);
    ...
    /*public function getStudentAssiduity($request){
        try{
			...
			$result = new stdClass();
			$result->details = DashboardPersistCtrl::getInstance()->getStudentAssiduity($courseId, $userId);				
			$this->prepareJson($result);
    ...
    public function getGroupsOverview($request){
        try{
			...
			$result = new stdClass();
            $result->details = DashboardPersistCtrl::getInstance()->getGroupsOverview($courseId, $groupId);
			$this->prepareJson($result);
    ...
    /*public function getStudentTracking($request){
        try{
			...
			$result = new stdClass();
            $result->details = DashboardPersistCtrl::getInstance()->getStudentTracking($courseId, $userId, $onlyMyGroups);
			$this->prepareJson($result);
    ...
    /*public function getUserProfile($request){
        try{
            ...
            $result = DashboardPersistCtrl::getInstance()->getUserProfile($userId);
			$this->prepareJson($result);
    ...
    public function getWorkFollowup($request){
        try{
			...
			$result = new stdClass();
            $result->details = DashboardPersistCtrl::getInstance()->getWorkFollowup($courseId, $groupId);
			$this->prepareJson($result);
    ...
    public function getStudentFollowup($request){
        try{
			...
			$result = new stdClass();
            $result->details = DashboardPersistCtrl::getInstance()->getStudentFollowUp($courseId, $groupId);
			$this->prepareJson($result);
    ...
    public function reportSectionResults($request){
        try{
            ...
            switch($output){
                case 'json':
                    $result = new stdClass();
                    $result->details = DashboardPersistCtrl::getInstance()->reportSectionResults($courseId, $groupId);
			        $this->prepareJson($result);
                    break;
                case 'csv':
                    $data = DashboardPersistCtrl::getInstance()->reportSectionResults($courseId, $groupId);
    ...
    public function reportActivityCompletion($request){
        try{
            ...
            switch($output){
                case 'json':
			        $result = new stdClass();
                    $result->details = DashboardPersistCtrl::getInstance()->reportActivityCompletion($courseId, $groupId);
                    $this->prepareJson($result);
                break;
                case 'csv':
                    $data = DashboardPersistCtrl::getInstance()->reportActivityCompletion($courseId, $groupId);
    ...
    public function reportQuiz($request){
        try{
            ...
            switch($output){
                case 'json':
			        $result = new stdClass();
                    $result->details = DashboardPersistCtrl::getInstance()->reportQuiz($courseId, $cmId, $groupId);
                    $this->prepareJson($result);
                break;
                case 'csv':
                    $data = DashboardPersistCtrl::getInstance()->reportQuiz($courseId, $cmId, $groupId);
